...
export const RECEPTIONIST_PHRASES = Object.freeze({
  ...
  QUESTION_ESTIMATE_DATE: 'What date would you prefer for the estimate? We schedule estimates {{estimate_days}}.',
  QUESTION_ESTIMATE_TIME: 'What time would you prefer? Available estimate times are from {{earliest_estimate_time}} through {{latest_estimate_time}}.',
  ...
  VALIDATION_CALLBACK_PHONE: 'I still need a valid callback phone number.',
  ...
  VALIDATION_ESTIMATE_DATE: 'I still need an upcoming date within the estimate schedule.',
  VALIDATION_ESTIMATE_TIME: 'I still need a time within the estimate schedule.',
