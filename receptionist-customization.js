...
export function buildQuestionCatalog({ business, ownerFirstName }) {
  ...
  return Object.freeze({
    ...
    project_location: {
      ...
      text: 'What is the project address? Please give me the city or town, state, street number, and street name.',
    ...
    estimate_schedule: {
      ...
      text: `Next, what exact date or upcoming day and time works best for the estimate? We offer estimates ${business.estimateDays} from ${business.earliestEstimateStart} through ${business.latestEstimateStart}.`,
    ...
    preferred_date: {
      ...
      text: 'What exact date or upcoming day would you prefer?',
